...
cp "./iOptronV3Conf.ui" "$TheSkyX_Path/Resources/Common/PlugInsARM32/MountPlugIns/"
...
if [ ! -z "$app_owner" ]; then
	...
	chown $app_owner "$TheSkyX_Path/Resources/Common/PlugInsARM32/MountPlugIns/iOptronV3Conf.ui"
